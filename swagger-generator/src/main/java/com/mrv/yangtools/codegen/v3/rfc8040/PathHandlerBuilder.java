 ...
 */
public class PathHandlerBuilder implements com.mrv.yangtools.codegen.v3.PathHandlerBuilder {
    private SchemaContext ctx;
    private OpenAPI target;
    ...
    public PathHandler forModule(Module module) {
        return new PathHandler(ctx, module, target, objBuilder, tagGenerators,fullCrud);
    }
    ...
    @Override
    public void configure(SchemaContext ctx, OpenAPI target, DataObjectBuilder builder) {
